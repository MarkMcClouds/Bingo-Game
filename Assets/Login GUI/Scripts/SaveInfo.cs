...
public class SaveInfo : MonoBehaviour
{
	...
	public string SaveInfoPhpURL = "http://romaniexchange.com/SaveInfo.php"; // don't forget to add the URL for the php script here.
	public string SecretKey = "112878112878";
